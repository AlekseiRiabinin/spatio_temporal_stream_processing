  ...
  override def process(
    ...
    out.collect(
      EnrichedEvent(
        ...
        speedAvg1m = speedAvg,
        speedStd1m = speedStd,
        accelerationAvg1m = accelerationAvg,
        jerkAvg1m = jerkAvg,
        turnRateAvg1m = turnRateAvg,
        idleRatio1m = idleRatio,
        distanceTraveled1m = distanceTraveled,
        congestionLevel1m = congestionLevel,
